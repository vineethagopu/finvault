...
export class BeneficiariesController {
  ...
  @Post() create(@CurrentUser('id') uid: string, @Body() dto: CreateBeneficiaryDto) { return this.service.create(uid, dto) }
  @Patch(':id') update(@CurrentUser('id') uid: string, @Param('id') id: string, @Body() dto: UpdateBeneficiaryDto) { return this.service.update(uid, id, dto) }
